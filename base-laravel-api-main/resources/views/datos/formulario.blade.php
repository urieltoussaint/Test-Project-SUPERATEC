...
<body>
    ...
    <form action="{{ route('formulario.store') }}" method="POST">
        ...
        <input type="email" id="direccion_email" name="direccion_email" required><br>
        ...
        <input type="text" id="telefono_casa" name="telefono_casa"><br>

        <label for="telefono_celular">Teléfono Celular:</label>
        <input type="text" id="telefono_celular" name="telefono_celular"><br>
